...
def normalizeLinear(input_data):
    normalizedPattern = []
    newHeight = 256
    newWidth = 256
    xMin = 256
...
def momentNormalize(input_data):
    normalizedPattern = []
    newHeight = 256
    newWidth = 256
    xMin = 256
    ...
    mu20_ = mu20(input_data, xc_)
    mu02_ = mu02(input_data, yc_)
...
def extractFeatures(input_data, interval):
    extractedPattern = []
    nrStrokes = len(input_data)
